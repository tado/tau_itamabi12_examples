...
struct FieldValuePair {
	...
	std::string getFieldAndValueForQuery(bool embedValue = false) {
		...
		if(embedValue) {
            ...
            if (value_part.find("date(") == std::string::npos &&
                value_part.find("time(") == std::string::npos &&
                value_part.find("datetime(") == std::string::npos &&
                value_part.find("julianday(") == std::string::npos &&
                value_part.find("strftime(") == std::string::npos) {
